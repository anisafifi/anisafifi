<div align="center">
  ...
  <!-- Hero Banner -->
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Anis%20Afifi&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32"/>
  
  <!-- Avatar with modern styling -->
  <img src="https://github.com/anisafifi.png" width="150" height="150" style="border-radius: 50%; border: 5px solid #fff; box-shadow: 0 10px 25px rgba(0,0,0,0.2); margin-top: -75px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);" alt="WebX Beyond Avatar" />
  
  <br><br>
  
  <!-- Animated Introduction -->
  <img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&size=28&duration=3000&pause=1000&color=667EEA&center=true&vCenter=true&multiline=true&width=800&height=100&lines=Full+Stack+Developer+%F0%9F%9A%80;UI%2FUX+Designer+%F0%9F%8E%A8" alt="Typing Animation" />
